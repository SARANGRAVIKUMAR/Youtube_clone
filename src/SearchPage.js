...
const SearchPage = () => {
  return (
    <div className="searchPage">
      ...
      <hr />
      <ChannelRow
        image="https://lh3.googleusercontent.com/ogw/ADGmqu86voMCdJViHm2j8PDyuU6Y0_w2Q5W5iHSQNR94Nw=s32-c-mo"
        channel="Sarang Ravikumar"
        verified
        subs="12K"
        noOfVideos={20}
        description="wdnadaldwdnadaldwdnadaldwdnadaldwdnadaldwdnadaldwdnadaldwdnadaldwdnadald"
      />
      <hr />
